...
#Coworker
define CW = Character("Billy", color = "#006ca5",image="billy")
image billy neutral= im.Scale("Co-worker/CW_Neutral.png", 700, 900)
image billy shocked= im.Scale("Co-worker/CW_Shocked.png", 700, 900)
image billy happy= im.Scale("Co-worker/CW_Happy.png", 700, 900)

#Barista
define F = Character("Felix", color = "#77DD77",image="felix")
image felix blushing= im.Scale("Barista/Barista blush.png", 650, 900)
image felix cheerful= im.Scale("Barista/Barista cheerful.png", 650, 900)
image felix thinking= im.Scale("Barista/Barista think.png", 650, 900)

#Sister
define E = Character("Helena", color = "#3A4D39",image="helena")
image helena neutral= im.Scale("Helena/helena neutral.png", 650, 900)
image helena sad= im.Scale("Helena/helena sad.png", 650, 900)
image helena smile= im.Scale("Helena/helena happy.png", 650, 900)
...
image happyemoji = im.Scale("happy emoji.png", 300,300)
image hover_happyemoji = im.Scale("hover happy emoji.png", 300,300)
image angryemoji = im.Scale("anger emoji.png", 300,300)
image hover_angryemoji = im.Scale("hover anger emoji.png", 300,300)
image sademoji = im.Scale("sad emoji.png", 300,300)
image hover_sademoji = im.Scale("hover sad emoji.png", 300,300)
image touchedemoji = im.Scale("love emoji.png", 300,300)
image hover_touchedemoji = im.Scale("hover love emoji.png", 300,300)
...
screen survey:
    imagebutton:
            ...
            ypos 400
            idle "happyemoji"
            hover "hover_happyemoji"
            action SetVariable(name,"happy"),Return()
    imagebutton:
            xpos 530
            ypos 400
            idle "angryemoji"
            hover "hover_angryemoji"
            action SetVariable(name,"angry"),Return()
    imagebutton:
            xpos 1020
            ypos 400
            idle "sademoji"
            hover "hover_sademoji"
            action SetVariable(name,"sad"),Return()
    imagebutton:
            xpos 1500
            ypos 400
            idle "touchedemoji"
            hover "hover_touchedemoji"
            action SetVariable(name,"touched"),Return()
...
label talk_to_helen:
    ...
    H blushing"What? Staring at me again I see."
    ...
    menu:
        ...
        "…You got something on your face":
            H neutral"Oh! Dammit, again? Can you take it off? Please…"
...
label no_breakfast:
    H smiling"That’s the spirit you deterministic sucker."
    K "What’s for breakfast?"
    H "French Toast."
    K "Nice, you always made them nicely."
    H neutral" …erm, from the convenience store."
...
label after_menu1:
    ...
    H blushing"Whatever do you mean?"
    K "…I love you."
    H "I love you too."
    scene black with slow_dissolve
    pause 3
...
label act2_start:
    ...
    show office_cubicle with slow_dissolve:
        blur 12
    show billy neutral with slow_dissolve
    ...
    menu:
        "I…need it? I’m perfectly fine.":
            CW shocked"…"
            CW neutral"Look, it’s fine to say that you are, but you shouldn’t lie to yourself."
        ...
        "I would if I could, but a man’s gotta eat.":
            ...
            CW shocked"For any other person I would agree. But not you."
...
label dialogue_work_1a:
    menu:
        "You. You think that there is something that happened to me, How so?":
            ...
            CW shocked"Why are you really like this?"
...
label dialogue_work_2:
    CW neutral"Your behavior the past week has been very concerning."
    ...
    CW shocked"What has gotten you like this? I can’t even begin to imagine, it must have been very bad. You must know tha-"
    menu:
        "IT WAS!":
...
label dialogue_work_3:
    ...
    CW neutral"I know what it's like to lose someone... {i}God!...do I know."
    K " {b}{i}...Lose...someone?"
    K "I- I don't-"
...
label dialogue_work_4:
    ...
    show helen neutral with slow_dissolve
    K "Ah, …Hey."
    H smiling"You look worse for wear. What happened?"
    K " I- *ahem. Just a little workplace drama, nothing special. Why...Why are you here?"
    H sad"I’m always there where you need me..."
    H smiling"So, have you had lunch yet?"
    K "No, I haven’t but that sounds like a great idea."
    H smiling"Hehe, that always made you feel better. C’mon take us to Julie’s, I’m feeling for some Italian."
    pause 5
    jump act3_start
...
label act3_start:
    ...
    show cafe with slow_dissolve:
        blur 6
    show helen neutral at slightright with slow_dissolve
    ...
    H sad"I’m seriously asking, Ken."
...
label dialogue_cafe_2:
    ...
    show felix cheerful at center with slow_dissolve
    K "What? Oh, I’m sorry for that. Umm…yeah, hi again. Can I have a table for one please?"
    F blushing"Wait, Lemme do the thing first!"
    K "Right. Sure, go ahead."
    F cheerful"Welcome to Julie’s! Have a seat and enjoy your respite, I’ll be your server for today, Felix!"
    ...
    F thinking"Although…She hasn’t been around lately, for about a few weeks now."
    F cheerful"{i}*gasp!{/i} Does she not like the-"
    ...
    K "...."
    F thinking"Hmm? Are you two…alright?"
    menu:
        "Yes, I’d say so. Why? Does anything seem wrong?":
            F cheerful"No, I just thought it’s sad seeing you alone here."
            ...
            F thinking"Are you not though? You looked genuinely sad, like a lost puppy."
            K "I just really miss her, that's all."
            F cheerful"What's keeping you from her? Did you two have a fight?...Just kidding! That's impossible."
            F "There, there..What really happened?"
            jump dialogue_cafe_3
        "Well…I think she is a bit too busy at work, but we’re alright.":
            F cheerful"That’s good to hear, you two are just so cute together!"
            ...
            F blushing"-The two of you together is more than your sum. Ha! See, I can be sweet too!"
            F cheerful"So lover boy, how are you holding up with your missus being too busy for you, and even me!"
            K "{i}*Sigh*{/i} Not well to be honest. I haven’t seen her for..."
            K "..."
            K "Since...when did I last see her..."
            F thinking"Hey...Long shifts at work wouldn’t make you miss her that much...What really happened?"
            jump dialogue_cafe_3
        "YES! Never been better!":
            F cheerful"Oh, please…didn’t your momma ever tell you to never lie to a cute barista?"
            ...
            F thinking"So what gives? What happened?"
            K "She...isn’t around that much anymore."
            F "And that’s not just because she’s busy at work"
            F cheerful"{i}*gasp{/i} Did you two break up?"
            F thinking"No...that's not quite right either you guys would never…the only would separate you two is..."
            K "Hahaha, what would that be?"
            F cheerful"{b}Death!"
            F thinking"Just kidding! But seriously what is it? Is she sick?"
            K "...When exactly did you last see her?"
            F "About...two weeks ago, why?"
            K "Was I with her?"
            F "Nope. She came here alone..."
            F cheerful"Ken, you look unwell."
...
label dialogue_cafe_3:
    ...
    F cheerful"Woah...Buddy you might be little too-"
    K "No, it's not like that, it's more than that. I...when is the last time you’ve seen her?"
    F thinking"Let’s see, I remember it’s when we had that autumn sale...So yeah, about two weeks ago and actually a bit more."
    ...
    K "I..."
    F cheerful"Hey...relax a bit. Take small breaths if you can’t do big ones."
...
label dialogue_cafe_4:
    ...
    F cheerful"Ken, sweetie, I’ll need you to calm down…my manager is looking this way. Look…how about I get you something to go- and you-"
    F blushing"Go sit in that comfy outdoor chair, and get your mind in order. What would you like for lunch, it’s my treat."
    menu:
        "Small pan pizza.":
...
label dialogue_cafe_4a:
    ...
    show cafe_outside with slow_dissolve:
        blur 6
    show felix cheerful with slow_dissolve
...
label dialogue_cafe_5:
    ...
    F thinking"Are you sure nothing traumatic or unusual happened to you around the time Helen left?"
    K "I can’t say, I don’t even know what the missing parts are."
    F cheerful"Then how about let’s start with the pieces that aren’t! In the two weeks that followed, how did your mind fill in for the lack of Helen?"
    ...
    F thinking"All because you didn’t have Helen at your side in reality…"
    ...
    F blushing"Yep! That would fix you right up! All you have to do is sit tight and wait."
    F thinking"Though…how long would that be…hmm…Did she ever take a long vacation before?"
    ...
    stop music fadeout 0.5
    pause 2
    F blushing"I’ve…Got nothing! I really shouldn’t be a detective, which is why I’m not."
    F cheerful"I’m sorry I couldn’t be more of a help. But hey, as long as she’s out there somewhere, I know that she’ll come around, you two are perfect for each other!"
    F "Hmm?"
...
label act4_start:
    ...
    K "Hmm…"
    CW happy"Though it seems I helped, at least somewhat."
    ...
    CW neutral" I know, as it should. For what happened, it’s only the only thing a person can do."
    ...
    K "Go out to what?"
    CW happy"Take on the world…I would say so?"
...
label act5_start:
    ...
    scene black with slow_dissolve
    pause 3
    "How did you feel about the interaction between Ken and Billy?"
    $ name="Response4"
    call screen survey
    ...
    show grocery_store_fridge with slow_dissolve:
        blur 6
    show helen sad with slow_dissolve
    H "Umm, hey…"
    K "Where have you been, Helen?"
    H smilingtears"I’ve been {i}*ahem*{/i} I have been…"
    K "Dead"
    H neutral"I have been dead."
    ...
    H smilingtears"’m glad you see it that way, it’s for the best. There’s nothing I can do for you now…All I ever was, was just there to delay the inevitable."
    K "…What even are you?"
    H neutral"I’m Helen, the one that is within you."
    ...
    H angry"KEN. Don’t. Don’t please…" with hpunch
    ...
    H sad"It won’t do, Ken. It’s not a fair replacement."
    ...
    H neutral"It will die off on its own, Ken. I’m not asking you to forget me, or to kill me a second time."
    ...
    H "…Can you do it?"
    K "I…I can’t…"
    H angry"It would hurt me the most to find out that, by loving me, you’ll have it worse!"
    K " ……"
    pause 3
    K " …….."
    K "…We said to each other once that “Love is a curse, and so I will curse you-”"
    H smilingtears" “-Curse you for eternity.” "
...
label act6_start:
    scene black with slow_dissolve
    "What did you about that recent scene?"
    $ name="Response5"
    call screen survey
    pause 5
    "This place you're taking us…Is it far?"
    "No. But I think you’ll like it."
    "Hehe, well…lead the way, lover"
    pause 5
    "We’re walking together again…"
    "With me by your side, looking up at you."
    "I’ll miss this."
    "And for me, I’ll miss everything…but you most of all."
    pause 5
    "I can’t call it sadness, but it’s not happiness either. I just feel like a great weight has been lifted off me, yet too much has been taken off, and now I feel weightless."
    ...
    H neutral"Yep, My appearance is finally fitting for what I am, a half-ghost, half-hallucination…or something between those. I’m still not sure."
    H smiling"I don’t really care though. I’m just glad I was able to even exist for you even for just a couple of weeks more."
    H sad"Doing so prevented you from…following me. And I even saved you from the brink there."
    ...
    H smilingtears"Hey, at least you listened to me in the end, that’s what matters."
    ...
    H smiling"{i}*chuckles*{/i} I know I was testing you…I’m glad you took it too heart this quickly."
    ...
    K "What? Okay…"
    H smiling"Okay. I’m a ghost right?"
    K "Or my hallucination, but yeah I guess so. Why?"
    H "Ghosts. Can float."
    K "Yeah, they do that."
    H neutral"Let me just…"
    K "Woah, HEY HELEN!"
    ...
    H smiling"Oh dear mortal…what has deemed you worthy of my countenance…{i}*pfft."
    ...
    H smilingtears"…You’ll be fine, I think. At this moment, I know you would love nothing else but to have me back. And thank you for that."
    ...
    H blushing"I…Thank you…"
    H smilingtears"And you made me the happiest during my life. No one can compare to you"
    ...
    H sad"Live for me, alright? That’s the last thing I can say, I have nothing more."
    K "…I guess, I’ll see you whenever, in the next life."
    K "Goodbye, Helen."
    H smiling"Goodbye, Ken. You are the love of my life. I loved you…"
    H "I love you."
    menu:
        "I love you too.":
...
label act7_start:
    scene black with slow_dissolve
    "How did you feel about letting go of Helen?"
    $ name="Response6"
    call screen survey
    pause 5
    ...
    show living_room with slow_dissolve:
        blur 6
    show helena neutral with slow_dissolve
    E "Hey, Ken, you doing okay?"
    K "As much as I could be. Come on inside."
    E smile"Why, thank you, I love what you have done with the place by the way. It feels modern but not too clean."
    K "Well, thanks but don’t thank me, that was mostly…Helen’s work."
    E neutral"Really? Didn’t know Helen became better at that."
    ...
    E sad"She really was building a life here, huh."
    ...
    E neutral"I’ve…said some choice words to you, last time we met. And I really take it all back. You’ve never held her back, quite the opposite really. I guess all I said was just…plain jealousy."
    ...
    E sad"So…I’m sorry for what I said back then."
    ...
    E neutral"You were in a state of deep distress. It's understandable really. What matters is that you came to your senses. And you didn’t bring harm to anyone, when you were in that state."
    E sad"You were so calm when you called me, I didn’t even believe it at first, but when I did well…"
    ...
    E neutral"But life will go on without her, that, in the end, is what we will all conclude."
    K "{i}*sigh*{/i} That much, I know to be true."
    K "…Well, lunch is ready, shall we?"
    E smile"Oh! Why, how kind of you, thank you."
    scene black with slow_dissolve
    scene living_room with slow_dissolve:
        blur 6
    show helena smile with slow_dissolve
    ...
    E neutral"You give your one hundred percent, when you get serious, I liked that about you. Helen always talked about you when you first started dating, made it seem like you were the dreamiest guy ever."
    ...
    E smile"Did she ever tell you that she has an exam around that time herself?"
    ...
    E neutral"I…came here to pay respects to Helen, of course. But I also came to check up on you as well. What you told me…of having this image of Helen for days…well…"
    K "It didn’t bring confidence towards my mental stability huh."
    E sad"It really didn’t. I was very concerned for you. I really was expecting much worse when I came to your apartment."
    ...
    E neutral"Right. Because no matter how much of you is lost, whatever remains is still you. And it's you in its entirety. A lesser copy, and what is lost is forever gone, but-"
    K "That’s only a chance to make it yourself anew. Different, but it is no lesser than what you were."
    E smile"Correct again, we…probably heard that from the same person huh."
    ...
    K "Okay, here’s yours."
    E  neutral"Let’s have a toast first."
    K "Sure"
    K "One"
    K "Two"
    K "Three"
...
label credits_presentation:
    ...
    "Would you like to review your playthrough?"
    menu:
        "Yes":
            jump wrapup
        "No":
